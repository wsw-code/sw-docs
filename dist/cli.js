...
async function bundle(root, config) {
  const resolveViteConfig = async (isServer) => ({
    ...
    plugins: await _chunkBS72D4WZjs.createVitePlugins.call(void 0, config, void 0, isServer),
    ssr: {
    ...
    build: {
      ...
      rollupOptions: {
        input: isServer ? _chunkBS72D4WZjs.SERVER_ENTRY_PATH : _chunkBS72D4WZjs.CLIENT_ENTRY_PATH,
        output: {
