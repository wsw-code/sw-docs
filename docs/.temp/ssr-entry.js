...
const routes = [
  { path: "/b", element: React__default.default.createElement(B) },
  { path: "/guide/a", element: React__default.default.createElement(A) },
  { path: "/guide/", element: React__default.default.createElement(Index) },
  { path: "/guide2/", element: React__default.default.createElement(Route3) },
  { path: "/", element: React__default.default.createElement(MDXContent) }
];
console.log(routes);
const Content = () => {
